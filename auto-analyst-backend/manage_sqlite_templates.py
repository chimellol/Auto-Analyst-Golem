...
# Handle path for SQLite database access
...
# Change to backend directory for SQLite database access
    ...
    try:
        if args.action == "populate":
            ...
            if confirm.lower() == "yes":
                ...
                # Restore directory even if cancelled
                os.chdir(original_cwd)
    except Exception as e:
        print(f"❌ Script failed: {e}")
        # Ensure directory is restored on any error
        os.chdir(original_cwd)
        sys.exit(1) 